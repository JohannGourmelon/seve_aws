...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/resources/css/saas/home.css" />
...
<body>
	<main>
			...
			<div class="presentation-container">
				...
				<div class="ctas-home">
					<div class="d-flex justify-content-center package-btn">
						<button class="btn btn-o btn-home" onclick="window.location.href='${pageContext.request.contextPath}/saasuser/showSignUpForm'">Créer mon compte</button>
					</div>
					<div class="d-flex justify-content-center package-btn">
		...
		<section>
			...
			<div class="features">
				<div class="feature-card shadow-o">
					<img src="${pageContext.request.contextPath}/resources/images/saas/panier.jpg" alt="" />
				...
				<div class="feature-card shadow-b">
					<img src="${pageContext.request.contextPath}/resources/images/saas/package-pres.png" alt="" />
					<div class="feature-card-content">
						<p class="text-center feature-name pt-3 pb-2">Suivi
							statistique</p>
						<ul>
				...
				<div class="feature-card shadow-g">
					<img src="${pageContext.request.contextPath}/resources/images/saas/planning.png" alt="" />
					<div class="feature-card-content">
						<p class="text-center feature-name pt-3 pb-2">Gestion des
							plannings</p>
						<ul>
		...
		<section>
			...
			<div class="steps">
				...
				<div class="step shadow-b p-3">
					...
					<p class="text-center">Je choisis le forfait adapté à mes
						besoins</p>
				</div>
				<div class="step shadow-g p-3">
					<p class="text-center number bg-g">3</p>
					<p class="text-center">Je configure mon site en quelques clics
					</p>
				</div>
				<div class="step shadow-o p-3">
		...
		<section>
			<h3 class="text-center">Prêt à simplifier la gestion de votre
				AMAP ?</h3>
			<div class="d-flex justify-content-center package-btn">
				<button class="btn btn-secondary m-3"
					onclick="window.location.href='${pageContext.request.contextPath}/saas/packages'">Découvrez nos forfaits</button>
			</div>
		</section>
	</main>
</body>
