...
<div class="container mt-3">
    <h1 class="mb-4 text-center">${amapProducerUser.id != null ? 'Modifier' : 'Création d\'un compte'} producteur</h1>

    <form action="${pageContext.request.contextPath}/${slug}/producer/signup"
        ...
        <div class="mb-3">
            ...
            <input type="text" id="rib" name="rib" class="form-control"
                   value="${amapProducerUser.rib != null ? amapProducerUser.rib : ''}"
